...
RESULTS="benchmarks/results/week6.md"
...
echo "# Week 6 Benchmark Results" > "$RESULTS"
echo "" >> "$RESULTS"
...
# --- TTL verification ---
echo ""
echo "=== TTL Verification ==="
redis-cli -p $KVSTORE_PORT SET ttltest hello
redis-cli -p $KVSTORE_PORT EXPIRE ttltest 2
echo -n "GET immediately (expect 'hello'): "
redis-cli -p $KVSTORE_PORT GET ttltest
echo "Waiting 3 seconds for expiry..."
sleep 3
echo -n "GET after expiry (expect nil): "
redis-cli -p $KVSTORE_PORT GET ttltest
